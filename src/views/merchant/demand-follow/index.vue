...
const searchFields = [
  { label: '关键词', prop: 'keyword', placeholder: '需求标题/需求企业/机构名称' },
  {
    label: '服务类型',
    prop: 'serviceType',
      ...
      <el-table v-loading="loading" :data="tableData" border>
        ...
        <el-table-column label="操作" width="200" fixed="right">
          <template #default="{ row }">
            ...
            <PermissionButton
              :permission="PERMISSION_CODE.enterpriseDemandHandle"
              text
